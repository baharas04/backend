...
export const getAllMateriController = async (req, res) => {
  try {
...
export const getMateriByIdController = async (req, res) => {
  const { id } = req.params;
  try {
...
export const updateMateriController = async (req, res) => {
  const { id } = req.params;
  const data = req.body;
...
export const deleteMateriController = async (req, res) => {
  const { id } = req.params;
  try {
